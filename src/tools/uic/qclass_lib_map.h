...
QT_CLASS_LIB(QSNAPScreen, QtGui, qscreensnap_qws.h)
...
QT_CLASS_LIB(QMatroxScreen, QtGui, qscreenmatrox_qws.h)
...
QT_CLASS_LIB(QVoodooScreen, QtGui, qscreenvoodoo_qws.h)
...
QT_CLASS_LIB(QVga16Screen, QtGui, qscreenvga16_qws.h)
...
QT_CLASS_LIB(QRepeaterScreen, QtGui, qscreenrepeater_qws.h)
QT_CLASS_LIB(QWSVr41xxKeyboardHandler, QtGui, qkbdvr41xx_qws.h)
QT_CLASS_LIB(QGfxShadow, QtGui, qscreenshadowfb_qws.h)
QT_CLASS_LIB(QShadowScreenCursor, QtGui, qscreenshadowfb_qws.h)
QT_CLASS_LIB(QShadowTimerHandler, QtGui, qscreenshadowfb_qws.h)
QT_CLASS_LIB(QShadowFbScreen, QtGui, qscreenshadowfb_qws.h)
QT_CLASS_LIB(QWSProtocolItem, QtGui, qwscommand_qws.h)
QT_CLASS_LIB(QWSIdentifyCommand, QtGui, qwscommand_qws.h)
QT_CLASS_LIB(QWSCreateCommand, QtGui, qwscommand_qws.h)
QT_CLASS_LIB(QWSRegionNameCommand, QtGui, qwscommand_qws.h)
QT_CLASS_LIB(QWSRegionCommand, QtGui, qwscommand_qws.h)
QT_CLASS_LIB(QWSSetOpacityCommand, QtGui, qwscommand_qws.h)
QT_CLASS_LIB(QWSRegionMoveCommand, QtGui, qwscommand_qws.h)
QT_CLASS_LIB(QWSRegionDestroyCommand, QtGui, qwscommand_qws.h)
QT_CLASS_LIB(QWSRequestFocusCommand, QtGui, qwscommand_qws.h)
QT_CLASS_LIB(QWSChangeAltitudeCommand, QtGui, qwscommand_qws.h)
QT_CLASS_LIB(QWSAddPropertyCommand, QtGui, qwscommand_qws.h)
QT_CLASS_LIB(QWSSetPropertyCommand, QtGui, qwscommand_qws.h)
QT_CLASS_LIB(QWSRepaintRegionCommand, QtGui, qwscommand_qws.h)
QT_CLASS_LIB(QWSRemovePropertyCommand, QtGui, qwscommand_qws.h)
QT_CLASS_LIB(QWSGetPropertyCommand, QtGui, qwscommand_qws.h)
QT_CLASS_LIB(QWSSetSelectionOwnerCommand, QtGui, qwscommand_qws.h)
QT_CLASS_LIB(QWSConvertSelectionCommand, QtGui, qwscommand_qws.h)
QT_CLASS_LIB(QWSDefineCursorCommand, QtGui, qwscommand_qws.h)
QT_CLASS_LIB(QWSSelectCursorCommand, QtGui, qwscommand_qws.h)
QT_CLASS_LIB(QWSPositionCursorCommand, QtGui, qwscommand_qws.h)
QT_CLASS_LIB(QWSGrabMouseCommand, QtGui, qwscommand_qws.h)
QT_CLASS_LIB(QWSGrabKeyboardCommand, QtGui, qwscommand_qws.h)
QT_CLASS_LIB(QWSPlaySoundCommand, QtGui, qwscommand_qws.h)
QT_CLASS_LIB(QWSQCopRegisterChannelCommand, QtGui, qwscommand_qws.h)
QT_CLASS_LIB(QWSQCopSendCommand, QtGui, qwscommand_qws.h)
QT_CLASS_LIB(QWSIMMouseCommand, QtGui, qwscommand_qws.h)
QT_CLASS_LIB(QWSIMResponseCommand, QtGui, qwscommand_qws.h)
QT_CLASS_LIB(QWSIMUpdateCommand, QtGui, qwscommand_qws.h)
...
QT_CLASS_LIB(QWSSoundServerClient, QtGui, qsoundqss_qws.h)
QT_CLASS_LIB(QWSSoundServerSocket, QtGui, qsoundqss_qws.h)
QT_CLASS_LIB(QCopChannel, QtGui, qcopchannel_qws.h)
QT_CLASS_LIB(QMachScreen, QtGui, qscreenmach64_qws.h)
